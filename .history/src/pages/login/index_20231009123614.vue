...
<script lang="ts" setup> // 不明白这么方便的写法 不用 非要steup包起来是吧...
...
const login = () => {
  ...
  console.log('通过类似vuex[这个官方不维护了](vuex的替代品pinia)保存用户数据，', userInfo,  token, userId, setUserInfo)
...
// 样式图片引入方式    mask-image: url('@/static/icon-play-white.png');
