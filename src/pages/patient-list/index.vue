  ...
  >
    <view class="top-info">
      <view class="search-input">
        <image src="~@/assets/patient-list/search.png" mode="scaleToFill" />
        <input
          confirm-type="search"
          placeholder="搜索患者名字"
          @confirm="onSearch"
    ...
    <view class="content common-content-bg">
        ...
        >
          <view class="basic-info">
            <view class="left">
              <image
                class="touxiang"
                src="~@/assets/patient-list/touxiang.png"
                mode="scaleToFill"
              />
              <view>
                <text>{{ item.name }}</text>
            ...
            /> -->
              <image
                v-if="item.isFocus"
                src="~@/assets/patient-list/focus.png"
                mode="scaleToFill"
              />
              <image
                v-else
                src="~@/assets/patient-list/unfocus.png"
                mode="scaleToFill"
              />
              <text>关注</text>
              <image
                src="~@/assets/patient-list/call.png"
                mode="scaleToFill"
      ...
      <view v-else class="empty-data">
        <image src="~@/assets/empty-data.png" mode="scaleToFill" />
        <text>暂无预警患者</text>
      </view>
    </view>
  </view>
